      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="section-subheading mx-auto">
            Mechanical Engineering student at UMass Lowell. Summer 2026 Mechanical Engineering Intern at Cirtronics Corporation. Always open to what's next. Let's connect.
          </p>
        </motion.div>
