...
const experiences = [
  {
    ...
    dwg:     'EXP-001',
    description: [
      'Supported mechanical engineers at an FDA- and ITAR-registered contract manufacturer serving the medical device, robotics, and defense industries.',
      'Assisted with electro-mechanical assembly and complex box-build projects, contributing to fixturing, assembly documentation, and design-for-manufacturability reviews.',
      'Shadowed senior engineers through new product introduction (NPI), gaining hands-on exposure to production processes, testing, and quality standards (ISO 9001/13485).',
    ],
